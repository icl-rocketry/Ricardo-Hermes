...
namespace Commands
{
    ...
    void getRSSI(ForwardDecl_SystemClass &system, const RnpPacketSerialized &packet);
    void pushSettings(ForwardDecl_SystemClass &system, const RnpPacketSerialized &packet);
    void testCMD(ForwardDecl_SystemClass &system, const RnpPacketSerialized &packet);
